    ...
    <div className="min-h-screen bg-[#F8F9FE] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-[#18191C]">Welcome Back</h2>
          <p className="text-[#5E6670] mt-2">Login to your QuickHire account</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button className="btn w-full bg-[#4F46E5] hover:bg-[#3f37c9] border-none text-white normal-case text-lg h-12">
            Login
          </button>
        </form>
